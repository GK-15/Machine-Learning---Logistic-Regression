...
X= np.append(X, np.atleast_2d(X[:,0]*X[:,1]).T, axis=1)
X= np.append(X, np.atleast_2d(X[:,0]**2).T, axis=1)
X= np.append(X, np.atleast_2d(X[:,1]**2).T, axis=1)
X= np.append(X, np.atleast_2d(X[:,0]**3).T, axis=1)
X= np.append(X, np.atleast_2d(X[:,1]**3).T, axis=1)
########################################/
